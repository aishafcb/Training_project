...
public class browsers {
  ...
  public void beforeClass(String wbsite, String br) {
			 if(br.equalsIgnoreCase("chrome")){
				 System.setProperty("webdriver.chrome.driver", "C:\\Users\\Aisha\\Downloads\\Training-20200223T143610Z-001\\Training\\Drivers\\chromedriver.exe");
			  driver=new ChromeDriver();
			  driver.navigate().to(wbsite);
			 driver.manage().window().maximize();
		  }else if(br.equalsIgnoreCase("firefox")) {
			  System.setProperty("webdriver.gecko.driver", "C:\\Users\\Aisha\\Downloads\\Training-20200223T143610Z-001\\Training\\Drivers\\geckodriver.exe");
